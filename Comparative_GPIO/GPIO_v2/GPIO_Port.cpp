...
enum PORT_ADDR_BASE { // This address is the address pin. Page. 399 http://ww1.microchip.com/downloads/en/DeviceDoc/Atmel-2549-8-bit-AVR-Microcontroller-ATmega640-1280-1281-2560-2561_datasheet.pdf
	AVR_PB = 0x0023,
	AVR_PE = 0x002C,
	AVR_PG = 0x0032,
	AVR_PH = 0x0100,
